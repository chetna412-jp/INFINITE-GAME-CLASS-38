...
function draw() {
  ...
  fill(255);
  fill("orange")
  text("Distance: "+ distance,displayWidth/2,displayHeight/22);
  fill("yellow")
  text("***************",655,60);
 // fill("maroon");
  
  //textFont("Times New Roman")
  //text("DRAG THE MOUSE TO MOVE THE PLAYER UP & DOWN!!!",200,40);
  ...
  fill("violet");
  text("press up arrow to restart the game!",displayWidth/3+35,displayHeight/2+60);
    path.velocityX = 0;
